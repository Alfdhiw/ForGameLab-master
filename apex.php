...
<body>
    ...
    <div class="body-apex">
        <?php include 'template/tabs_action.php' ?>
                    ...
                    <div class="post-container">
                        ...
                        <a href="post_detail.php" style="text-decoration: none;">
                            <div class="post-content">
                                <h2>New Updates Coming with Apex Legends™: From The Rift</h2>
                                <div class="post-images">
                                    <img src="bahan/apex/apex-update.png" alt="gambar 1" class="post-image" />
                                </div>
                                <div class="post-tags">
                                    <a href="#">#apex</a>
                                    <a href="#">#GetUpdate</a>
